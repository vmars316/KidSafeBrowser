...
onload = function() {
  ...
  document.querySelector('#reload').addEventListener(
    ...
    function() {
  console.log("vm  "+" #reload').addEventListener ");
      if (!isLoading) {
...
function resetExitedState() {
  console.log("vm  "+" resetExitedState ");
...
function handleFindUpdate(event) {
  console.log("vm  "+" handleFindUpdate ");
...
function findBoxObscuresActiveMatch(findBoxRect, matchRect) {
  ...
  console.log("vm  "+" findBoxObscuresctiveMatch ");
}

function handleKeyDown(event) {
  console.log("vm  "+" handleKeyDown ");
  if (event.ctrlKey) {
...
function handleLoadCommit() {
  console.log("vm  "+"handleLoadCommit  ");
  resetExitedState();
  var webview = document.querySelector('webview');
...
function handleLoadAbort(event) {
  console.log("vm  "+" handleLoadAbort ");
...
function handleLoadRedirect(event) {
  console.log("vm  "+" handleLoadRedirect ");
  resetExitedState();
